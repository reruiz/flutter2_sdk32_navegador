// ignore_for_file: prefer_final_fields, prefer_const_constructors, prefer_const_constructors_in_immutables

import 'package:flutter/material.dart';

import 'package:flutter2_sdk32_navegador/src/widgets/floats_buttons/transform_float_button.dart';
...
class AnimatedFloatingActionButtonState
  ...
  Widget build(BuildContext context) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.start, //##### endTop
      //mainAxisAlignment: MainAxisAlignment.end, //##### endDocked
  ...
  List<Widget> _buildFABs() {
    ...
    processButtons.add(_buildMainFAB()); //##### endTop
    for (int i = 0; i < widget.fabButtons.length; i++) {
      //var _n = widget.fabButtons.length; //##### endDocked
      processButtons.add(
        Opacity(
          ...
          child: TransformFloatActionButton(
            ...
            translateValue: 0 - _translateButton.value * (i + 1), //##### endTop
            //translateValue: _translateButton.value * (_n - i),   //##### endDocked
          ),
        ),
      );
    }
    //processButtons.add(_buildMainFAB()); //##### endDocked
